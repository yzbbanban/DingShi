package lt.riti.com.dingshi.utils;
...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if (StockApplication.getAppContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(StockApplication.getAppContext(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            toast.show();
    ...
    public static void showLongToast(String msg) {
        if (StockApplication.getAppContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(StockApplication.getAppContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.show();
